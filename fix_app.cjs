const fs = require('fs');
const content = fs.readFileSync('frontend/components/CitizenApp.tsx', 'utf8');
const lines = content.split('\n');

const startIndex = 280; // <AnimatePresence mode="wait">
const endIndex = 423;   // {view === 'confirm' && (
...
fs.writeFileSync('frontend/components/CitizenApp.tsx', newLines.join('\n'));
